/**
 * Regenerate public/veritasium_channel_data_10.json using the yt-dlp YouTube job.
 *
 * Usage (from project root):
 *   node scripts/generate_veritasium_sample.js
 */
...
async function main() {
  ...
  while (true) {
    ...
    console.log(`${p.done} / ${p.total} - ${p.status} (${percent}%)`);
